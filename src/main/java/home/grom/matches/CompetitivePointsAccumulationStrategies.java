...
public final class CompetitivePointsAccumulationStrategies {
    ...
    public static final int DEFAULT_ON_WIN_POINTS = 3;
    public static final int DEFAULT_ON_LOSE_POINTS = 0;
    public static final int DEFAULT_ON_TIE_POINTS = 1;
    ...
    public static CompetitivePointsAccumulationStrategy defaultAccumulationStrategy() {
        return CompetitivePointsAccumulationStrategy.builder()
                .onWinGain(DEFAULT_ON_WIN_POINTS).onLoseGain(DEFAULT_ON_LOSE_POINTS).onTieGain(DEFAULT_ON_TIE_POINTS)
                .build();
    }
}
